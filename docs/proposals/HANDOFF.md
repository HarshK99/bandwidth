...
- Added short generic guides inside work cards: Deep work shows “Discovery · Positioning · Sales · Decisions”; Light work shows “Lead research · Posting · Admin”; Execution shows “Production · Editing · Revisions”. Existing card size calculations and title sizes stay unchanged. Guides wrap naturally without truncation or line clamping. Browser fit remains unverified.
- Tree: Wave Link, Freelance, Content, Side projects, Jobs, Recovery and life. User requested renaming Exploration to Side projects; the internal preview identifier remains unchanged. Removed the invented standalone Tools and learning branch: the source document permits useful tooling improvements but does not prescribe a recurring deep-work task for them.
- User authorized renaming Low-energy work to Light work; updated the HTML labels and filters.
- Source document describes 14:00–15:30 as sleepier and 15:30–17:00 as improving; it does not mandate different task classes. Preview now proposes Light work at 14:00–15:30 and Execution at 15:30–17:00. This distinction is an interpretation for discussion, not an established source rule. Execution filters production/editing work; Light work filters routine research, posting, and admin. Complex production can still appear in Deep work.
...
- Effort: Deep work, Light work, Execution, Recovery. One activity may fit multiple effort filters without duplicate data; examples include Outreach and Website production. These are suitability suggestions, not statements that the source document assigns every activity to a fixed energy level.
...
## Next starting point
Latest accepted wording: renamed the visible Execution label to Production throughout Today and Coverage (the internal `execution` key stays unchanged). Generic card guides are now Deep work: “Think · Solve · Decide · Discuss”; Production: “Build · Write · Edit · Refine”; Light work: “Research · Post · Follow up · Admin”. This supersedes the earlier wording above. User approved these as modes of working rather than fixed business stages; task difficulty still determines suitable effort. No task classifications or schedule times changed in this wording-only update.
