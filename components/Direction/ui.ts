...
export const LABEL = "text-[11px] font-medium uppercase tracking-[0.16em]";
/** Even quieter caption, for meta lines inside dense UI. */
export const LABEL_XS = "text-[10px] font-medium uppercase tracking-[0.14em]";
 ...
 */
export const FIELD =
  "min-h-8 w-full rounded-sm border border-transparent bg-transparent px-1.5 py-1 text-sm " +
...
export const BUTTON =
  "inline-flex min-h-8 items-center justify-center gap-1.5 rounded-md px-2 text-[13px] " +
...
/** Bordered control cluster (date stepper, popover shell). */
export const SURFACE =
  "rounded-md border border-black/10 bg-white shadow-[0_8px_24px_-12px_rgba(0,0,0,0.25)] " +
